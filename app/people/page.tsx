      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-8">
          <button
            ...
            className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 backdrop-blur-sm border border-white/20 text-white/90 hover:text-white px-4 py-2 rounded-full text-sm font-medium transition-all mb-6"
          >
