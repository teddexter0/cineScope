...
import { ArrowLeft, Film, Tv, Star, Plus, TrendingUp, CalendarDays, Sparkles, ChevronLeft, ChevronRight } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 p-4">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap gap-2 mb-5">
          {[
            { key: 'discover',   label: '🔍 Browse',         icon: null },
            { key: 'upcoming',   label: '🎬 Upcoming Movies', icon: null },
            { key: 'now_airing', label: '📺 Now Airing',      icon: null },
          ].map(s => (
            <button key={s.key} onClick={() => { setSection(s.key as Section); setPage(1) }}
        ...
        {section === 'discover' && (
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 border border-white/20 mb-6 space-y-4">

            {/* Movie / Series toggle */}
            <div className="flex items-center gap-2">
              <span className="text-white/60 text-sm w-20 flex-shrink-0">Type</span>
            ...
            <div className="flex items-start gap-2">
              <span className="text-white/60 text-sm w-20 flex-shrink-0 mt-1">Genre</span>
            ...
            {mediaType === 'movie' && (
              <div className="flex items-start gap-2">
                <span className="text-white/60 text-sm w-20 flex-shrink-0 mt-1">Era</span>
                <div className="flex flex-wrap gap-2">
            ...
            {/* Sort */}
            <div className="flex items-center gap-2">
              <span className="text-white/60 text-sm w-20 flex-shrink-0">Sort by</span>
              <div className="flex flex-wrap gap-2">
                {SORT_OPTIONS.map(o => (
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 text-white/60">No results found. Try adjusting your filters.</div>
        ) : (
          <>
